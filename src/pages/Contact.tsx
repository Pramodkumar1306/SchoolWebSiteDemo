              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Main Office: +91 135 266 6271<br />
                      Admissions: +91 135 266 6272<br />
                      Emergency: +91 135 266 6273
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      General: info@doonacademy.edu.in<br />
                      Admissions: admissions@doonacademy.edu.in<br />
                      Principal: principal@doonacademy.edu.in
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Located in the heart of Dehradun, easily accessible from all parts of the city
            </p>
          </motion.div>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="aspect-w-16 aspect-h-9 bg-gray-200 h-96 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-2">The Doon Academy, Mall Road, Dehradun</p>
              </div>
            </div>
          </div>
        </div>
